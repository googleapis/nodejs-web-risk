...
describe('v1.WebRiskServiceClient', () => {
    ...
    describe('computeThreatListDiff', () => {
        it('invokes computeThreatListDiff without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.webrisk.v1.ComputeThreatListDiffRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.webrisk.v1.ComputeThreatListDiffResponse());
            ...
            assert((client.innerApiCalls.computeThreatListDiff as SinonStub)
    ...
    describe('searchUris', () => {
        it('invokes searchUris without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.webrisk.v1.SearchUrisResponse());
            client.innerApiCalls.searchUris = stubSimpleCall(expectedResponse);
            const [response] = await client.searchUris(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchUris as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('searchHashes', () => {
        it('invokes searchHashes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.webrisk.v1.SearchHashesRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.webrisk.v1.SearchHashesResponse());
            client.innerApiCalls.searchHashes = stubSimpleCall(expectedResponse);
            const [response] = await client.searchHashes(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchHashes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createSubmission', () => {
        it('invokes createSubmission without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.webrisk.v1.CreateSubmissionRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.webrisk.v1.Submission());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createSubmission as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
